...
class MockDataProvider {
        ...
        var goals: [MockGoal] = [
            MockGoal(id: "5", title: "Wedding Fund", icon: "heart.fill", currentAmount: 2000, targetAmount: 15000, status: "Paid", currency: "GEL"),
            MockGoal(id: "4", title: "Home Renovation", icon: "house.fill", currentAmount: 3000, targetAmount: 10000, status: "Unpaid", currency: "GEL"),
            MockGoal(id: "3", title: "New Laptop", icon: "laptop", currentAmount: 700, targetAmount: 1500, status: "Paid", currency: "GEL"),
            MockGoal(id: "2", title: "Car", icon: "car", currentAmount: 1000, targetAmount: 5000, status: "Unpaid", currency: "USD"),
            MockGoal(id: "1", title: "Vacation", icon: "airplane", currentAmount: 500, targetAmount: 2000, status: "Paid", currency: "EUR")
        ]
    }
