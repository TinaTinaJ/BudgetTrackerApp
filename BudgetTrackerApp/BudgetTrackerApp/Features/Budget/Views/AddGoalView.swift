...
struct AddGoalView: View {
    ...
    @State internal var goalTitle = ""
    @State internal var costAmount = ""
    @State internal var selectedCurrency = "GEL"
    @State internal var showAlert = false
    @State private var isLoading = false
    @State internal var errorMessage = "Please enter both a goal title and a valid cost amount."
